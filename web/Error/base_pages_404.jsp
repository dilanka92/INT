<%-- 
    Document   : base_pages_404
    Created on : 18-Jul-2015, 17:56:36
    Author     : Dilanka
--%>
...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../assets/less/modules/base.bootstrap-overwrite.less" type="text/css"/>
        <link rel="stylesheet" href="../assets/less/modules/base.bootstrap-overwrite.less" type="text/css">
    ...
    <body>
        ...
        <div class="content pulldown text-muted text-center">
            ...
            <a class="link-effect" href="javascript:void(0)">Report it</a> or <a class="link-effect" href="index.jsp">Go Back to Dashboard</a>
        </div>
        <!-- END Error Footer -->
